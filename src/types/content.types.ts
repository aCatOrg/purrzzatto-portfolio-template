...
export type Person = {
  ...
  languages?: Array<{
    ...
    /** Proficiency level */
    level?: "fluent" | "advanced" | "intermediate" | "beginner";
  }>;
};
...
export interface About extends BasePageConfig {
  ...
  work: {   /** Whether to display work experience */
    display: boolean;
...
/**
 * Auxuliary type to decouple nested logic in About page Experience section
 */
export interface Experience {
  ...
  /** Role or job title */
  role: string;
  /** List of responsibilities in two different types */
